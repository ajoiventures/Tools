...
wom_items = [
    ...
    (6,  'Driveway Oak Overhang — Front Laurel Oak', '📍 Front driveway edge',      'addon', 'Add-on',
     'Limbs from our front Laurel Oak hang over the driveway. Trim the driveway-side overhang to restore vehicle clearance.',
     ['Trim driveway-side overhanging limbs on front Laurel Oak', 'Raise clearance to safe vehicle height']),
