...
| [`fax-cli/`](fax-cli/) | Python CLI — send faxes from terminal | Local |
...
```bash
python fax-cli/send_fax.py --to 18008290115 --file document.pdf
python fax-cli/send_fax.py --irs-numbers
```
